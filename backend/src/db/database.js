...
export function initDatabase() {
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS notifications (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      user_id INTEGER NOT NULL REFERENCES users(id) ON DELETE CASCADE,
      type TEXT NOT NULL CHECK(type IN ('match_available','match_reminder','match_closed','result_published','points_earned','top_three','points_adjustment','match_comment','match_mention','reaction','chat_reply','chat_mention')),
      title TEXT NOT NULL,
  ...
  if (!notificationsSql.includes("'match_comment'") || !notificationsSql.includes("'match_mention'") || !notificationsSql.includes("'match_available'") || !notificationsSql.includes("'match_reminder'") || !notificationsSql.includes("'reaction'") || !notificationsSql.includes("'chat_reply'") || !notificationsSql.includes("'chat_mention'")) {
    db.exec(`
