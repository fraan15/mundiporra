...
function AdminMatches(){
  ...
  const startEdit=m=>{setEdit(m.id);setForm({match_date:m.match_date,match_time:m.match_time,stadium:m.stadium,team1:m.team1,team2:m.team2,auto_close_at:m.auto_close_at.slice(0,16),force_published:Boolean(m.force_published)})};
