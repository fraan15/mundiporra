...
function AdminSettings(){
 const [form,setForm]=useState(null),[notice,setNotice]=useState(""),[syncing,setSyncing]=useState(false),[syncError,setSyncError]=useState("");useEffect(()=>{api("/admin/settings").then(setForm)},[]);if(!form)return null;
