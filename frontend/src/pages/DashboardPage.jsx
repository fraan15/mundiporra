...
export function DashboardPage() {
  ...
  <section className="worldcup-dashboard-actions" aria-label="Informacion del Mundial">
    ...
    <button onClick={()=>navigate("/mundial?tab=knockout")}><ListTree size={20}/><span><strong>Cuadro Eliminatorias</strong><small>Cruces actualizados</small></span><ArrowRight size={17}/></button>
  </section>
