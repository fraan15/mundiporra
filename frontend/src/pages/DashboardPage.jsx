...
export function DashboardPage() {
  ...
  <div className="dashboard-overview"><div className="dashboard-stats">{[["Puntos totales",s.total_points],["Posición",`#${s.position}`]].map(([k,v])=><article key={k}><span>{k}</span><strong>{v}</strong></article>)}</div>
